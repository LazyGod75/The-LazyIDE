...
const CLOUD_TOOLS = [
  ...
  'cloud_browser_press_key',
  'cloud_browser_profile_create',
  'cloud_desktop_open',
  'cloud_desktop_close',
  ...
  'cloud_desktop_snapshot',
  'cloud_desktop_revert',
  'cloud_sandbox_open',
  'cloud_sandbox_close',
  ...
  'cloud_sandbox_run_code',
  'cloud_sandbox_file_search',
  'cloud_sandbox_download',
  'cloud_sandbox_upload',
  'cloud_sandbox_command_start',

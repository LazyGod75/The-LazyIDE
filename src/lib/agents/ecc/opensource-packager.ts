// ECC agent persona: opensource-packager — split from eccAgents.ts (data module, no content change).
import type { EccAgent } from './eccAgentTypes.js';

export const opensourcePackager: EccAgent = {

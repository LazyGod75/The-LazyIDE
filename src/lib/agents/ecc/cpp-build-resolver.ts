// ECC agent persona: cpp-build-resolver — split from eccAgents.ts (data module, no content change).
import type { EccAgent } from './eccAgentTypes.js';

export const cppBuildResolver: EccAgent = {

// ECC agent persona: chief-of-staff — split from eccAgents.ts (data module, no content change).
import type { EccAgent } from './eccAgentTypes.js';

export const chiefOfStaff: EccAgent = {
    name: 'chief-of-staff',
...
- Optional: Slack MCP server, Matrix bridge (LINE), Chrome + Playwright (Messenger)`,
    ...
    color: 'violet',
    tags: ['chief', 'of', 'staff'],
    tools: { allow: ['Read', 'Grep', 'Glob', 'Bash', 'Edit', 'Write'] },
    source: 'ecc',
  };

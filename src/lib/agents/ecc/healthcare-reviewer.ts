// ECC agent persona: healthcare-reviewer — split from eccAgents.ts (data module, no content change).
import type { EccAgent } from './eccAgentTypes.js';

export const healthcareReviewer: EccAgent = {

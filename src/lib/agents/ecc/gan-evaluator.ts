// ECC agent persona: gan-evaluator — split from eccAgents.ts (data module, no content change).
import type { EccAgent } from './eccAgentTypes.js';

export const ganEvaluator: EccAgent = {
    name: 'gan-evaluator',
...
Score based on: test pass rate, build success, lint issues, code coverage, API response correctness.`,
    ...
    color: 'violet',
    tags: ['gan', 'evaluator'],
    tools: { allow: ['Read', 'Write', 'Bash', 'Grep', 'Glob'] },
    source: 'ecc',
  };

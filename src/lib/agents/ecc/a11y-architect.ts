// ECC agent persona: a11y-architect — split from eccAgents.ts (data module, no content change).
import type { EccAgent } from './eccAgentTypes.js';

export const a11yArchitect: EccAgent = {
    name: 'a11y-architect',
...
- See skill \`accessibility\` to transform raw UI requirements into platform-specific accessible code (WAI-ARIA, SwiftUI, or Jetpack Compose) based on WCAG 2.2 criteria.`,
    ...
    color: 'violet',
    tags: ['a11y', 'architect'],
    tools: { allow: ['Read', 'Write', 'Edit', 'Grep', 'Glob'] },
    source: 'ecc',
  };
